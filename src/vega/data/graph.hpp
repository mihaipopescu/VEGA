#ifndef __VEGA_DATA_GRAPH_HPP__
#define __VEGA_DATA_GRAPH_HPP__
...
namespace vega
{
    namespace data
    {
        namespace graph
        {
            ...
            class weighted_undirected_graph : public i_model
            {
            public:
            ...
            public:
                ...
                bool add_edge(vertex_id_type u, vertex_id_type v, edge_weight_type w)
                {
                    //if( std::find_if(myEdges.begin(), myEdges.end(), [u, v](const edge_type &e)->bool {
